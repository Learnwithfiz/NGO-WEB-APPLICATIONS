<?php
     ...
     $query = "SELECT * FROM  admin_notice WHERE Id = '$id'";
     ...
     if(isset($_POST['add'])){
      ...
      $upadte= "UPDATE   admin_notice SET TITLE='$title',TEXTT='$text'
      WHERE id = '$id'";
...
<body>
  ...
  "> Admin Dashboard   <span style="
    ...
    color:white;
    float:right;
  ">Edit notice  Page Data</span></h1>


<div class="container ">
         <h1 class="  p-4 text-muted"> Edit Moderate </h1>
