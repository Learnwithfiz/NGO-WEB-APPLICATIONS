   ...
   $welcome = "Welcome ";
    ...
    if(isset($_POST['submit'])){
       ...
       //check phone number 
         ...
         $check_email = "SELECT * FROM moderate WHERE email ='$email';";
         $mysql = mysqli_query($connect,$check_email);
         ...
         if($count>0){
            ...
            $query="INSERT INTO moderate(Name,fname,mname,email,img,nid,nidNext,phone,date,work,salary,pass) 
            VALUES('$name','$fname','$mname','$email','$img','$nid','$nidNext','$phone','$date','$work','$salary','$pass')";
...
<body>
   ...
   <button class="btn btn-success p-3 m-5 "><a style="border:none;color:wheat !important" href="AdminMain.php">Home</a></button>
