...
<div class="mod-title text-center text-white bg-dark p-2">
   ...
   <button onclick="window.print()" class="btn btn-primary ">print</button> 
     <div class="container">
        <div class="row">
            <h1>Application for loan  Information</h1>
...
<div class="row p-0 m-0">
    ...
    <div class="border p-5" style="width:100%;height:700px;box-shadow:3px 4px 10px black">
          <div class="mod-img">
            ...
            <h6 class="text-muted"> phone :<span style="color:gray"> <?php  echo $row['loan_pori']; ?> </span></h6>  <br>
    ...
    <td>  <img  style="width:200px;height:120px" src="App_img/<?php  echo $row['img']  ?>" alt=""> </td>
                                <td><img  style="width:300px;height:200px" src="App_img/<?php  echo $row['nid']  ?>" alt=""></td>
                                <td><img style="width:300px;height:200px" src="App_img/<?php  echo $row['nidNext']  ?>" alt=""></td>
