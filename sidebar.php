     ...
     session_start();
      ...
      if(isset($_POST['add'])){
        ...
        $size1 =$_FILES['ssliderImage']['type'];
            ...
            $sql= "INSERT INTO  homepage (headline,crImage,sliderImage,Tcount,Tproject,Dcount) VALUES('$headline','$img_name2','$img_name1','$Tcount','$Tproject','$Dcount')";
         ...
         if($query){
             ...
             move_uploaded_file($img_path1,"upload_image/".$img_name1);
         }
         ...
         <div class="row"style="border:4px solid green; ">
                ...
                <div class="logo">
                     ...
                     <form action="" method="POST" enctype="multipart/form-data">
                           ...
                           <div>
                             ...
                             <div>
                               <p> Carousel Image  </p>
                               <input type="file" name="crrImage"><br><br>
                           </div>
                         
                           <div>
                  <p> second Carousel Image  </p>
                     <input type="file"name="ssliderImage" ><br><br>
              </div>
                     
               ________ Achievement_______
                 <div>
                     <p> Count Total client </p>
                     <input type="text"name="Tcount"><br><br>
                 </div>
                </div> 
             </div>
            ...
            <div class="col-lg-4">
                 ...
                 <div>
                     ...
                     <input type="text"name="Tproject"><br><br>
                 </div>
                 <div>
                     <p> Count Dept. awards </p>
                     <input type="text"name="Dcount"><br><br>
                 </div>
                      ...
                      <table>
                           ...
                           <?php
                                ...
                                <tr>
                                    ...
                                    <td><img height="120px"width="100px" src="upload_image/<?php  echo $row['crImage']  ?>" alt=""></td>
                                    <td><img height="120px"width="100px" src="upload_image/<?php  echo $row['sliderImage']  ?>" alt=""></td>
                                    <td><?php  echo $row['Tcount'] ; ?></td>
                                    <td><?php  echo $row['Tproject'] ; ?></td>
                                    <td><?php  echo $row['Dcount'] ; ?></td>


                                    <td><a id="a-href" href="Edit.php?id=<?php  echo $row['id'] ;?>"><button class="btn btn-primary text-white">Edit</button></a></td>
                                    <td><a id="a-href" href="Delete.php?id=<?php  echo $row['id'] ;?>"><button class="btn btn-primary text-white">DELETE</button></a></td>
                                </tr>
