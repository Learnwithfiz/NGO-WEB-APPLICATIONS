                        ...
                        <?php
                           ...
                           while($row=mysqli_fetch_array($query)){?>
                            ...
                            <tr>
                                ...
                                <td><a href="moderateEdit.php?id=<?php echo $row['Id'] ;?>"><button class="btn btn-danger p-2">Edit</button></a></td>
                                <td><a href="ModerateDelete.php?id=<?php echo $row['Id'] ;?>"><button class="btn btn-danger p-2">Delete</button></a></td>
                                <td><a href="mview.php?id=<?php echo $row['Id'] ;?>"><button class="btn btn-danger p-2">view</button></a></td>
