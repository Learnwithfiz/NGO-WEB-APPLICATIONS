                        ...
                        <?php
                           ...
                           while($row=mysqli_fetch_array($query)){?>
                            ...
                            <tr>
                                ...
                                <td><?php  echo $row['loan_pori']  ?></td>
                              
                                <td><a href="application_admin_delete.php?id=<?php echo $row['id'] ;?>"><button class="btn btn-danger p-2" Onclick="return confirm('are you want to delete???')" >Delete</button></a></td>
                                <td><a href="print.php?id=<?php echo $row['id'] ;?>"><button class="btn btn-danger p-2"  >view</button></a></td>
