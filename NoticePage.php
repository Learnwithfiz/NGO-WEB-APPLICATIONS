...
<body>
   ...
   <br><br><br><br><br>
       ...
       <div class="top-title text-center text-primary">
       <h1>Notice For Mobile banking</h1>
       </div>
       <br><br><br>

        <div class="row p-0 m-0">
           <div class="col-lg-12">
              <img src="Image/bb.png" width="100%" alt="">
           </div>

           <div class="col-lg-12">
              <img src="Image/rrr.jpg" width="100%" alt="">
           </div>
        </div>  
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
               <div class="box" 
               style="border:3px solid green ; width:100%;height:450px;padding:10px"  >
                  <h1 class="text-center text-primary">Daily Notice</h1>
                  <hr style="border:2px solid green;border-bottom:none">
                   <h6 class="text-center text-primary pt-5">***  Every SutarDay to ThursDay 10 A.M - 5 P.M ***</h6>
            
                  
                   <hr style="border:2px solid green;border-bottom:none">
                   <h3 class="text-center text-primary pt-5">Othorse </h3>
                    <br><br>
                   <h5 class="text-center text-danger p-4"><?php  echo $row['Notice']; ?></h5>
                  </div>
            </div>
          </div>
        </div>
